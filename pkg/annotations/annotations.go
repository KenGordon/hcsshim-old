...
const (
	...
	// For example:
	//
	//	"[{\"Key\": {\"Hive\": \"System\", \"Name\": \"registry\\path\"}, \"Name\": \"Name\", \"Type\": \"String\", \"StringValue\": \"value\"}]"
	//
...
// TODO (helsaawy): make this a `func() map[string][]string`, so callers cannot modify the expansions
