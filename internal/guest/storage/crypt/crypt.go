...
// Test dependencies
var (
	_copyEmptySparseFilesystem = storage.CopyEmptySparseFilesystem
	_createSparseEmptyFile     = storage.CreateSparseEmptyFile
	...
	_getBlockDeviceSize        = storage.GetBlockDeviceSize
	_osMkdirTemp               = os.MkdirTemp
	_mkfsExt4Command           = storage.MkfsExt4Command
