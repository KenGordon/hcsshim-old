...
const (
	...
	WorkerExitDetail_FAST_SAVE_PRESERVE_PARTITION_HANDLE_TRANSFER_STORAGE                WorkerExitDetail = "FastSavePreservePartitionHandleTransferStorage"
	WorkerExitDetail_FAST_SAVE_PRESERVE_PARTITION_HANDLE_TRANSFER_NETWORKING             WorkerExitDetail = "FastSavePreservePartitionHandleTransferNetworking"
	WorkerExitDetail_FAST_SAVE_PRESERVE_PARTITION_HANDLE_TRANSFER_STORAGE_AND_NETWORKING WorkerExitDetail = "FastSavePreservePartitionHandleTransferStorageAndNetworking"
	WorkerExitDetail_FAST_SAVE_PRESERVE_PARTITION_HSR                                    WorkerExitDetail = "FastSavePreservePartitionHsr"
)
