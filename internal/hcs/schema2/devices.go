...
type Devices struct {
	...
	// A list of instances that describes emulated network adapters
	EmulatedNetworkAdapter []EmulatedNetworkAdapter `json:"EmulatedNetworkAdapter,omitempty"`
	EmulatedS3VideoMonitor *EmulatedS3VideoMonitor  `json:"EmulatedS3VideoMonitor,omitempty"`
}
